...
void DynamicDescriptorHeap::CommitStagedDescriptors(
    ...
    std::function<void(ID3D12GraphicsCommandList*, UINT, D3D12_GPU_DESCRIPTOR_HANDLE)> setRootDescTableFunc) {
    ...
    if(numDescriptorsToCommit > 0) {
        ...
        while(_BitScanForward(&rootIndex, m_StaleDescriptorTableBitMask)) {
            ...
            setRootDescTableFunc(d3d12GraphicsCommandList, rootIndex, m_CurrentGPUDescriptorHandle);
